...
import { FileText, CheckCircle, Calendar, Heart, AlertCircle, Bell } from "lucide-react";
...
interface Notification {
  ...
  message: string;
  time: string;
  type: 'application' | 'analysis' | 'interview' | 'interest' | 'reminder' | 'system';
  read: boolean;
  link?: string;
}
...
export default function NotificationsPage() {
  ...
  return (
    <DashboardLayout userRole="candidate">
      <div className="flex-1 bg-white rounded-tl-[24px] min-h-screen">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <h3 className={`text-sm font-bold text-[#1A1A1A] ${!notification.read ? 'font-bold' : 'font-medium'}`}>
                          {notification.title}
                        </h3>
